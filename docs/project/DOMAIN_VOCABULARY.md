# ForgeWorks Terminology

Creating a **domain language** (a real one, not marketing fluff).
That’s exactly how strong platforms differentiate themselves without over-engineering.
...
# 🔥 ForgeWorks Domain Vocabulary

## 1. Core Actions (Replacing “build / create”)

These are your **primary verbs** — they should appear everywhere.

| Generic Term   | Forge Term          | Usage Example                 |
| -------------- | ------------------- | ----------------------------- |
| Build service  | **Forge service**   | “Forge a new service”         |
| Create project | **Forge project**   | “Forge project from template” |
| Scaffold       | **Forge from mold** | “Forge from approved mold”    |
| Generate       | **Forge artifact**  | “Forge service artifacts”     |
| Initialize     | **Ignite forging**  | “Ignite forging process”      |

**Why it works:**
“Forge” implies **intentional shaping**, not automation spam.

---

## 2. Templates & Standards (Golden Paths without saying it)
...
## 3. Process Stages (UI flow language)
...
## 4. Quality & Readiness (Replacing “prod-ready”)
...
## 6. Evolution & Feedback (Dynamic consistency theme)
...
## TL;DR (Why this is a great move)
