...
| [`AB-030_LABEL_SCHEMA_VALIDATOR.md`](AB-030_LABEL_SCHEMA_VALIDATOR.md) | v0.3 draft (GT amendments landed 2026-07-29 unblocking F3/F4/F8; interim rules lifted) — awaiting scoping-approval | Shared library that enforces `GROUND_TRUTH_INTERVENTION_CONTRACT.md` v0.2 §2.1/§2.2/§3/§5 rules on every label event before emission. Blocks AB-028 spike execution per that RFC's §3 Schema-conformance block. |
